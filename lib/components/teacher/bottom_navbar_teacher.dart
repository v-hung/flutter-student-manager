...
class BottomNavBarTeacher extends ConsumerStatefulWidget {
  const BottomNavBarTeacher({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _BottomNavBarTeacherState();
}

class _BottomNavBarTeacherState extends ConsumerState<BottomNavBarTeacher>{
    ...
    return Container(
      ...
      child: NavigationBar(
        ...
        onDestinationSelected: (int index) {
          ...
          // });
          context.go("/teacher${menu[index]['path']}");
        },
